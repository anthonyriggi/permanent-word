...
const OUTPUT_PATH = path.join(SOURCE_DIR, "full-bible-gutenberg.json");
const OUTPUT_HASH_PATH = path.join(SOURCE_DIR, "full-bible-gutenberg.sha256.txt");
...
function main() {
  ...
  console.log("");
  console.log("Imported the full Bible from Gutenberg source.");
...
try {
  ...
  console.error("");
  console.error("Full Bible import failed.");
